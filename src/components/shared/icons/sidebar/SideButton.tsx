...
import { AlwaysBlackFillPath } from '../../paths/AlwaysBlackFillPath'
import { AlwaysAccentFillPath } from '../../paths/AlwaysAccentFillPath'

export const SideButton = () => (
    <SVG xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
        <AlwaysAccentFillPath d="M0 13C0 20.1797 5.8203 26 13 26C20.1797 26 26 20.1797 26 13C26 5.8203 20.1797 0 13 0C5.8203 0 0 5.8203 0 13Z" />
        <AlwaysBlackFillPath
            fillRule="evenodd"
            clipRule="evenodd"
