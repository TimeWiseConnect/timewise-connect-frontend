...
export const useWatchForm = () => {
    const { author, name, childName, connections, disabilty, grade, request, phone } = useStore($formStore)
    useEffect(() => {
    ...
    }, [author, name, childName, connections, disabilty, grade, request, phone])
}
